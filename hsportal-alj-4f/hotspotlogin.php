...
<head>
  ...
  <link href=\"template/bootstrap/css/custom.css\" rel=\"stylesheet\" type=\"text/css\" /> 
  <script src=\"template/bootstrap/js/jquery.slim.min.js\"></script>
...
if ($result == 1) {
  ...
  <center>
    <h2 id='timetitle'></h2>
    <a href=\"http://$uamip:$uamport/logoff\">Logout</a><br>
   <p>or type logout/ in to your browser</p>
  </center>
</body>
</html>";
}
